...
@Component({
  selector: 'app-manager-project-update',
  templateUrl: './manager-project-update.component.html',
  styleUrl: './manager-project-update.component.css',
})
export class ManagerProjectUpdateComponent {
  projects: any[] = [];
